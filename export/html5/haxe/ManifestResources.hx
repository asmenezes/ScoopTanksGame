...
@:keep @:dox(hide) class ManifestResources {
	...
	public static function init (config:Dynamic):Void {
		...
		data = '{"name":null,"assets":"aoy4:pathy36:assets%2Fmusic%2Fmusic-goes-here.txty4:sizezy4:typey4:TEXTy2:idR1y7:preloadtgoR0y36:assets%2Fsounds%2Fsounds-go-here.txtR2zR3R4R5R7R6tgoR0y28:assets%2Fdata%2FTileSet.jsonR2i308R3R4R5R8R6tgoR0y31:assets%2Fdata%2Fmap_Barrels.csvR2i924R3R4R5R9R6tgoR0y24:assets%2Fdata%2Fmap.jsonR2i7474R3R4R5R10R6tgoR0y23:assets%2Fdata%2Fmap.tmxR2i3954R3R4R5R11R6tgoR0y23:assets%2Fdata%2Fmap.csvR2i1098R3R4R5R12R6tgoR0y30:assets%2Fdata%2Fmap_Blocks.csvR2i924R3R4R5R13R6tgoR0y32:assets%2Fimages%2Ftank_green.pngR2i15118R3y5:IMAGER5R14R6tgoR0y37:assets%2Fimages%2FexplosionSmoke5.pngR2i16647R3R15R5R16R6tgoR0y31:assets%2Fimages%2FTileSheet.pngR2i40531R3R15R5R17R6tgoR0y33:assets%2Fimages%2FBarrelSheet.pngR2i13363R3R15R5R18R6tgoR0y32:assets%2Fimages%2FBlockSheet.pngR2i26702R3R15R5R19R6tgoR0y36:assets%2Fimages%2Ftank_darkLarge.pngR2i15620R3R15R5R20R6tgoR2i39706R3y5:MUSICR5y28:flixel%2Fsounds%2Fflixel.mp3y9:pathGroupaR22y28:flixel%2Fsounds%2Fflixel.ogghR6tgoR2i2114R3R21R5y26:flixel%2Fsounds%2Fbeep.mp3R23aR25y26:flixel%2Fsounds%2Fbeep.ogghR6tgoR2i33629R3y5:SOUNDR5R24R23aR22R24hgoR2i5794R3R27R5R26R23aR25R26hgoR2i15744R3y4:FONTy9:classNamey35:__ASSET__flixel_fonts_nokiafc22_ttfR5y30:flixel%2Ffonts%2Fnokiafc22.ttfR6tgoR2i29724R3R28R29y36:__ASSET__flixel_fonts_monsterrat_ttfR5y31:flixel%2Ffonts%2Fmonsterrat.ttfR6tgoR0y33:flixel%2Fimages%2Fui%2Fbutton.pngR2i519R3R15R5R34R6tgoR0y36:flixel%2Fimages%2Flogo%2Fdefault.pngR2i3280R3R15R5R35R6tgh","rootPath":null,"version":2,"libraryArgs":[],"libraryType":null}';
...
@:keep @:file("assets/data/TileSet.json") @:noCompletion #if display private #end class __ASSET__assets_data_tileset_json extends haxe.io.Bytes {}
@:keep @:file("assets/data/map_Barrels.csv") @:noCompletion #if display private #end class __ASSET__assets_data_map_barrels_csv extends haxe.io.Bytes {}
@:keep @:file("assets/data/map.json") @:noCompletion #if display private #end class __ASSET__assets_data_map_json extends haxe.io.Bytes {}
...
@:keep @:file("assets/data/map_Blocks.csv") @:noCompletion #if display private #end class __ASSET__assets_data_map_blocks_csv extends haxe.io.Bytes {}
@:keep @:image("assets/images/tank_green.png") @:noCompletion #if display private #end class __ASSET__assets_images_tank_green_png extends lime.graphics.Image {}
@:keep @:image("assets/images/explosionSmoke5.png") @:noCompletion #if display private #end class __ASSET__assets_images_explosionsmoke5_png extends lime.graphics.Image {}
...
@:keep @:image("assets/images/BarrelSheet.png") @:noCompletion #if display private #end class __ASSET__assets_images_barrelsheet_png extends lime.graphics.Image {}
@:keep @:image("assets/images/BlockSheet.png") @:noCompletion #if display private #end class __ASSET__assets_images_blocksheet_png extends lime.graphics.Image {}
@:keep @:image("assets/images/tank_darkLarge.png") @:noCompletion #if display private #end class __ASSET__assets_images_tank_darklarge_png extends lime.graphics.Image {}
